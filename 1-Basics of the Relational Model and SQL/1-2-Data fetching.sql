...
для поля title задать имя(псевдоним)
...
количества и вычисляет новые цены книг.
...
SELECT
    ...
    ROUND(
        IF(author="Булгаков М.А.", price+(price * 0.1),
            IF(author='Есенин С.А.', price+(price * 0.05),
